...
remoteV=`wget -qO- https://github.com/Hossein383/CFwarp/raw/main/CFwarp.sh | sed -n 4p | cut -d '"' -f 2`
...
wget -qO /root/warpip/$cpu https://github.com/Hossein383/CFwarp/raw/main/point/$cpu && chmod +x /root/warpip/$cpu
cd /root/warpip
./$cpu >/dev/null 2>&1 &
wait
cd
...
v4v6
if [[ -z $v4 ]]; then
wget -qO /root/warpip/ip.txt https://github.com/Hossein383/CFwarp/raw/main/point/ip6.txt
else
wget -qO /root/warpip/ip.txt https://github.com/Hossein383/CFwarp/raw/main/point/ip.txt
fi
wget -qO /root/warpip/$cpu https://github.com/Hossein383/CFwarp/raw/main/point/cpu/$cpu && chmod +x /root/warpip/$cpu
cd /root/warpip
./$cpu >/dev/null 2>&1 &
wait
cd
...
upcfwarp(){
wget -N https://github.com/Hossein383/CFwarp/raw/main/CFwarp.sh
chmod +x /root/CFwarp.sh 
...
wget -N https://github.com/Hossein383/CFwarp/raw/main/wp-plus.py 
...
wget -N https://github.com/Hossein383/CFwarp/-/raw/main/warp-go_1.0.8_linux_${cpu} -O /usr/local/bin/warp-go && chmod +x /usr/local/bin/warp-go
...
upwarpgo(){
kill -15 $(pgrep warp-go) >/dev/null 2>&1 && sleep 2
wget -N --no-check-certificate https://github.com/Hossein383/CFwarp/-/raw/main/warp-go_1.0.8_linux_${cpu} -O /usr/local/bin/warp-go && chmod +x /usr/local/bin/warp-go
systemctl restart warp-go
systemctl enable warp-go
systemctl start warp-go
...
echo -e " ${yellow}$(wget -qO- https://github.com/Hossein383/CFwarp/raw/main/version/warpV)${plain}"
echo -e " 可选择8进行更新\n"
fi
if [[ $(type -P warp-go) ]] && [[ -f '/root/CFwarp.sh' ]]; then
loVERSION="$(/usr/local/bin/warp-go -v | sed -n 1p | awk '{print $1}' | awk -F"/" '{print $NF}')"
wgVERSION="$(wget -qO- https://github.com/Hossein383/CFwarp/raw/main/version/warpgoV)"
...
wget -N https://github.com/Hossein383/CFwarp/raw/main/wgcf_2.2.17_$cpu -O /usr/local/bin/wgcf && chmod +x /usr/local/bin/wgcf         
if [[ $main -lt 5 || $minor -lt 6 ]] || [[ $vi =~ lxc|openvz ]]; then
[[ -e /usr/bin/wireguard-go ]] || wget -N https://github.com/Hossein383/CFwarp/raw/main/wireguard-go -O /usr/bin/wireguard-go && chmod +x /usr/bin/wireguard-go
fi
yellow "正在申请WARP普通账户，请稍等"
echo | wgcf register
